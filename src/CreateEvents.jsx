    ...
    return (
        <div className="events">
            ...
            <div className="date-picker">
                <DatePicker className="date-time-picker" type="text" selected={newEvent.start} showTimeSelect dateFormat="Pp" placeholderText={"Click to add start time"} 
                onChange={(start ) => setNewEvent( { ...newEvent, start } )} />
                <DatePicker className="date-time-picker" type="text" selected={newEvent.end} showTimeSelect dateFormat="Pp" placeholderText={"Click to add end time" }
